...
3.  **Build the Docker Image:**
    The project already includes a `Dockerfile`. Build your Docker image. Replace `your-project-id` and `your-service-name` with your Google Cloud Project ID and desired service name:
